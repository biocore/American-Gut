...
\topalign{\includegraphics[trim=180 250 160 120, clip, width=0.39\textwidth]{pdfs-mod1/agp_hmp.pdf}} &
\topalign{\includegraphics[width=0.20\textwidth]{pdfs-mod1/legend_agp_hmp_pgp.pdf}} &
\topalign{\includegraphics[trim=110 250 260 180, clip, width=0.39\textwidth]{pdfs-mod1/agp_pgp.pdf}}
\end{tabular}
}
...
\topalign{\includegraphics[trim=140 170 220 260, clip, width=0.39\textwidth]{pdfs-mod1/agp_gg_country.pdf}} &
\topalign{\includegraphics[width=0.20\textwidth]{pdfs-mod1/legend_agp_gg.pdf}} & \\ \addlinespace[4mm]
\twelvept{\bf{B}} & & \\ \addlinespace[-4mm]
\topalign{\includegraphics[trim=140 170 220 260, clip, width=0.39\textwidth]{pdfs-mod1/agp_gg_age.pdf}} &
