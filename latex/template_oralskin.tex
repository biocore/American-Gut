...
\begin{tabular}{ m{4.4cm} m{16cm} }  %<--does better with vertical spacing
	~~\includegraphics[height=0.08\textheight]{statics/logoshape.pdf} & \includegraphics[height=0.065\textheight]{statics/youramericangutsampletext.pdf} \\
\end{tabular}
...
{\huge How do your \sampletype{} microbes compare to others?} \hspace{1cm} \includegraphics[scale=0.45]{statics/ball_legend.pdf}
...
\begin{overpic}[width=2.10in]{figure4.pdf}
	\ifthenelse{\equal{\sampletype}{oral}}{\put(-32,-42){\includegraphics[width=3.65in]{statics/barchart_overlay_oral.pdf}}}{}
	\ifthenelse{\equal{\sampletype}{skin}}{\put(-32,-42){\includegraphics[width=3.65in]{statics/barchart_overlay_skin.pdf}}}{}
\end{overpic} 
...
\hspace{-5mm}
\raisebox{27mm}{
\includegraphics[scale=0.40]{statics/figure1_legend.pdf}}
\hspace{-2mm}
...
\hspace{5mm}
\ifthenelse{\equal{\sampletype}{oral}}{\includegraphics[scale=0.40]{statics/figure3_legend_firmicutes.pdf}}{}
\ifthenelse{\equal{\sampletype}{skin}}{\includegraphics[scale=0.40]{statics/figure3_legend_proteobacteria.pdf}}{}
\hspace{-2mm}
