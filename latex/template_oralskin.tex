...
\begin{overpic}[height=0.30\textheight]{pdfs-oralskin/agppcoa.pdf}
	...
	\ifthenelse{\equal{\sampletype}{skin}}{\put(185,0){\includegraphics[scale=0.40]{pdfs-oralskin/agppcoa_legend_skin.pdf}}}{}
\end{overpic} 


\\ \addlinespace[-2mm]

% captions - change make box to frame box to see borders of captions
