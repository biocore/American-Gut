...
\begin{tabular}{ @{} m{4.5cm} m{16cm} }  %<--does better with vertical spacing
	\includegraphics[height=0.08\textheight]{pdfs/new_logo_texgyre.png} & {\fontfamily{pbk}\fontsize{40}{50}\selectfont YOUR AMERICAN GUT} \\
\end{tabular}
...
\begin{overpic}[height=0.30\textheight]{pdfs/figure2.pdf}
	...
	\put(165,0){\includegraphics[scale=0.40]{pdfs/figure2_country_legend.pdf}}
 	\put(210,182){\includegraphics[scale=0.45]{pdfs/ball_legend.pdf}}
\end{overpic}
}
%
\hspace{8mm}
