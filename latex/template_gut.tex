...
\begin{tabular*}{\textwidth}{ m{0.5in} m{3.5in} m{8.0in} }
    ...
    \begin{overpic}[width= 2.10in]{figure4.pdf}
		\put(-32,-39){\includegraphics[width=3.65in]{statics/figure4_overlay.pdf}}
	\end{overpic} 
    &
    {\normalsize 
    \vspace{2.5mm}
...
{\huge How do your gut microbes compare to others?} \hspace{1cm} \includegraphics[scale=0.45]{statics/ball_legend.pdf}
...
%\hspace{11mm}
\raisebox{38.7mm}{
\includegraphics[scale=0.395]{statics/figure2_country_legend.pdf}}
\hspace{-2mm}
\subfloat[\fontfamily{phv}\selectfont{\normalsize Different Nationalities}\label{subfig-2:dummy}]{%
\includegraphics[scale=0.56, trim=3.5cm 1cm 2cm 2cm, clip=true]{figure2.pdf}
}
%\hspace{19mm}
\includegraphics[scale=0.40]{statics/figure3_legend.pdf}
\hspace{-2mm}
