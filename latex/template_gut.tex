...
\includegraphics[scale=0.50, trim=3.5cm 1cm 2cm 2cm, clip=true]{pdfs-gut/figure1.pdf}
}
%\hspace{11mm}
\raisebox{38.7mm}{
...
\includegraphics[scale=0.50, trim=3.5cm 1cm 2cm 2cm, clip=true]{pdfs-gut/figure2.pdf}
}
%\hspace{19mm}
\includegraphics[scale=0.40]{pdfs-gut/figure3_legend_firmicutes.pdf}
\hspace{-2mm}
\subfloat[\fontfamily{phv}\selectfont{\normalsize Phylum Firmicutes abundance}\label{subfig-3:dummy}]{%
\includegraphics[scale=0.50, trim=3.5cm 1cm 2cm 2cm, clip=true]{pdfs-gut/figure3.pdf}
}
