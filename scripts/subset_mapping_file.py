...
1) verify the sample ids in the table are a subset of the samples in the metadata
2) slice the metadata as to make a 100% overlap between the samples in the table and the samples in the metadata
"""
